...
export default function EnhancedNotificationDropdown() {
 ...
 <div
  ...
  className="relative p-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all duration-300 group shadow-sm hover:shadow-md border border-transparent hover:border-blue-200 cursor-pointer"
>
