...
import { Settings, CreditCard, User, HelpCircle, Bell, Lock, Globe, Mail, ArrowLeft, Check, Phone, MessageCircle, FileText, Shield } from 'lucide-react'
...
const SettingsDropdownNav = () => {
  ...
  const handleSectionClick = (section) => {
    ...
    // Don't close dropdown immediately - let it stay open
  }
  ...
  // Handle mouse enter with slight delay to prevent accidental opening
  ...
  // Handle mouse leave with delay to give users time to move to dropdown
  ...
  const MainPage = () => (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-blue-100 text-xl mb-8">Combining expert knowledge with world-class matching technology</p>
              ...
              {[
                {
                  ...
                  answer:
                    "Use our advanced matching algorithm by providing detailed project requirements. Our system will match you with consultants based on expertise, experience, availability.",
                },
                {
                  question: "What payment methods do you accept?",
                  answer:
                    "We accept all major credit cards, PayPal, and bank transfers. Enterprise customers can also set up invoice-based billing.",
                },
                {
                  question: "How do I cancel my subscription?",
                  answer:
                    "You can cancel your subscription anytime from the Manage Subscription page. Your access will continue until the end of your current billing period.",
                },
                {
                  question: "Is my data secure?",
                  answer:
                    "Yes, we use enterprise-grade security measures including SSL encryption, regular security audits, and compliance with industry standards.",
                },
              ].map((faq, index) => (
