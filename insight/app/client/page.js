    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* <nav className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <div className="text-2xl font-bold text-blue-600">Consultant Match </div>
              <div className="hidden md:flex items-center space-x-6">
                <Button className="flex items-center text-gray-700 hover:text-blue-600">
                  Find talent <ChevronDown className="ml-1 h-4 w-4" />
                </Button>
...
// import { Badge } from "@/components/ui/badge"
// import { Avatar, AvatarFallback } from "@/components/ui/avatar"
// import { Search, ChevronDown, Star, Heart, Bookmark, MapPin, Clock } from "lucide-react"
// import Image from "next/image"
...
//       name: "Lisa Thompson",
//       title: "Business Consultant",
//       skills: ["Strategy", "Business Analysis", "Project Management", "Process Improvement", "Leadership"],
//       rating: 4.8,
//       hourlyRate: 120,
//       location: "Chicago, IL",
//       avatar: "LT",
...
//           <div className="flex justify-between items-center h-16">
//             <div className="flex items-center space-x-8">
//               <div className="text-2xl font-bold text-blue-600">upwork</div>
//               <div className="hidden md:flex items-center space-x-6">
//                 <Button className="flex items-center text-gray-700 hover:text-blue-600">
//                   Find talent <ChevronDown className="ml-1 h-4 w-4" />
//                 </Button>
...
// import { Badge } from "@/components/ui/badge"
// import { Avatar, AvatarFallback } from "@/components/ui/avatar"
// import { Search, ChevronDown, Star, Heart, Bookmark } from "lucide-react"
...
//       <section className="relative overflow-hidden">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
//           <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-purple-800 rounded-3xl overflow-hidden min-h-[500px] flex items-center">
//             {/* Background Image */}
...
//               <div className="absolute inset-0 bg-gradient-to-r from-blue-900/95 via-blue-800/80 to-blue-700/50"></div>
//             </div>

//             <div className="relative z-10 px-8 py-16 lg:px-16 lg:py-24 w-full">
//               <div className="max-w-2xl">
...
//                 {/* Search Interface */}
//                 <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 space-y-4">
//                   <div className="flex space-x-2">
//                     <Button
//                       variant="outline"
...
//                     <div className="flex flex-wrap items-center gap-6">
//                       <div className="text-white/90 font-semibold">Microsoft</div>
//                       <div className="text-white/90 font-semibold">airbnb</div>
//                       <div className="text-white/90 font-semibold">Bissell</div>
//                       <div className="text-white/90 font-semibold">GLASSDOOR</div>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                  I specialize in helping tech startups design and execute winning go-to-market strategies. 
//                  With deep experience in SaaS business models, market research, and competitive analysis, 
//                  I work closely with founding teams to uncover growth opportunities 
//                  and translate vision into actionable plans.
//               </p>

//               <div className="flex flex-wrap gap-2 mb-4">
//                 {["Business Strategy", "Market Analysis", "SaaS", "Go-to-Market", "Competitive Analysis"].map(
//                   (skill) => (
//                     <Badge key={skill} variant="outline" className="text-blue-600 border-blue-200">
//                       {skill}
//                     </Badge>
